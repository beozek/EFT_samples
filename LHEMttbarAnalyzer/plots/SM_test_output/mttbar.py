...
def overlay_histograms_normalized():
    ...
    file1 = ROOT.TFile.Open("0_700_SM_all.root")
    file2 = ROOT.TFile.Open("700_900_SM_all.root")
    file3 = ROOT.TFile.Open("900_Inf_all.root")
    ...
    hist1 = file1.Get("LHEMttbarAnalyzer/mttbar_status").Clone("hist1")
    hist2 = file2.Get("LHEMttbarAnalyzer/mttbar_status").Clone("hist2")
    hist3 = file3.Get("LHEMttbarAnalyzer/mttbar_status").Clone("hist3")
    ...
    c1.SaveAs("mttbar_indv_normalized_status_2.png")
    c1.Clear()

    hist_combined.Draw("HIST")
    c1.SaveAs("mttbar_comb_normalized_status_2.png")
