...
def overlay_histograms_normalized():
    ...
    hist1 = file1.Get("LHEMttbarAnalyzer/mttbar_sm").Clone("hist1")
    hist2 = file2.Get("LHEMttbarAnalyzer/mttbar_sm").Clone("hist2")
    hist3 = file3.Get("LHEMttbarAnalyzer/mttbar_sm").Clone("hist3")
