...
def plot_numLeps():
    ...
    hist_name = "LHEMttbarAnalyzer/nleps"
    ...
    c1 = ROOT.TCanvas("c1", "numLeptons Distribution", 800, 600)
    c1.SetGrid()

    hist1.GetXaxis().SetTitle("Number of Leptons")
    if normalize:
    ...
    output_image = "numLeps_indv_weighted_normalized.png"
