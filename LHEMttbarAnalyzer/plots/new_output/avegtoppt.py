...
def plot_averageTopPt_with_combined():
    ...
    file1_path = "lhe_gen_sep_0_700.root"
    file2_path = "lhe_gen_sep_700_900.root"
    file3_path = "lhe_gen_sep_900Inf.root"
    ...
    hist_name = "LHEMttbarAnalyzer/averageTopPt"
    ...
    c1 = ROOT.TCanvas("c1", "averageTopPt Distribution", 800, 600)
    c1.SetGrid()

    hist1.GetXaxis().SetTitle("Average Top Pt [GeV]")
    if normalize:
    ...
    output_image = "averageTopPt_combined_weighted_normalized.png"
...
if __name__ == "__main__":
    plot_averageTopPt_with_combined()
