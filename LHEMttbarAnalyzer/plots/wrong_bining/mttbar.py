...
def overlay_histograms_normalized():
    ...
    file1 = ROOT.TFile.Open("0_700_SM_ref_EFT.root")
    file2 = ROOT.TFile.Open("700_900_SM_ref_EFT.root")
    file3 = ROOT.TFile.Open("900_Inf_SM_ref_EFT.root")
    ...
    hist1 = file1.Get("LHEMttbarAnalyzer/mttbar_sm_bin50").Clone("hist1")
    hist2 = file2.Get("LHEMttbarAnalyzer/mttbar_sm_bin50").Clone("hist2")
    hist3 = file3.Get("LHEMttbarAnalyzer/mttbar_sm_bin50").Clone("hist3")
    ...
    c1.SaveAs("mttbar_indv_sm.png")
    c1.Clear()

    hist_combined.Draw("HIST")
    c1.SaveAs("mttbar_comb_sm.png")
