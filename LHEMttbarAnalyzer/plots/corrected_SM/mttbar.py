...
def overlay_histograms_normalized():
    ...
    file1 = ROOT.TFile.Open("0_700_SM.root")
    file2 = ROOT.TFile.Open("700_900_SM.root")
    file3 = ROOT.TFile.Open("900_Inf_SM.root")
    ...
    hist1 = file1.Get("LHEMttbarAnalyzer/mttbar_refpoint_bin50").Clone("hist1")
    hist2 = file2.Get("LHEMttbarAnalyzer/mttbar_refpoint_bin50").Clone("hist2")
    hist3 = file3.Get("LHEMttbarAnalyzer/mttbar_refpoint_bin50").Clone("hist3")
    ...
    c1.SaveAs("mttbar_indv_refpoint.png")
    c1.Clear()

    hist_combined.Draw("HIST")
    c1.SaveAs("mttbar_comb_refpoint.png")
