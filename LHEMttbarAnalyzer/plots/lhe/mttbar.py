...
def overlay_histograms_normalized():
    ...
    file1 = ROOT.TFile.Open("lhe_SM_0_700.root")
    file2 = ROOT.TFile.Open("lhe_SM_700_900.root")
    file3 = ROOT.TFile.Open("lhe_SM_900Inf.root")
    ...
    c1.SaveAs("mttbar_status_indv_normalized_lhe_newbad.png")
    c1.Clear()

    hist_combined.Draw("HIST")
    c1.SaveAs("mttbar_status_comb_normalized_lhe_newbad.png")
